...
<body class="body">
    ...
    <section>
        ...
        <div class="mycart-nav-bar">
            <div onclick="window.location='../user/mycart.php'" class="mycart-nav-bar-item">
                <span>To Pay</span>
            </div>
            ...
            <div style="border-bottom: 4px solid rgb(57, 128, 235);" onclick="window.location='../user/completed.php'" class="mycart-nav-bar-item">
                <span>Completed</span>
            </div>
        </div>
        ...
        <div class="mycart-container">
            ...
            <br>
                <?php
                    $sqll = "Select count(*) from cart WHERE uid='$uid' AND status='Order Received'";
                    ...
                    $sql2 = "Select * from cart WHERE uid='$uid' AND status='Order Received' limit $offset, $rec_limit";
                            ...
                            echo "<div style='margin: auto; width: 80%; border: solid black 2px;'>";
                                ...
                                echo "<div class='mycart-item-lower'>";
                                    ...
                                    echo "<div class='mycart-item-lower-2'>";
                                        echo "<button id='paynow-btn' onclick=\"linkTrack('".$row['tracking_num']."')\">Track Order</button>";
                                        echo "<div id='paynow-btn' onclick=\"window.location='../user/product_buy_information.php?productID=".$row_productInformation['product_id']."'\">Buy Again</div>";
                                    echo "</div>";
                                echo "</div>";
