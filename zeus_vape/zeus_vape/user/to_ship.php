...
<body class="body">
    ...
    <section>
        ...
        <div class="mycart-nav-bar">
            ...
            <div style="border-bottom: 4px solid rgb(57, 128, 235);" onclick="window.location='../user/to_ship.php'" class="mycart-nav-bar-item">
                <span>To Ship</span>
            </div>
                            ...
                            echo "<div style='margin: auto; width: 80%; border: solid black 2px;'>";
                                ...
                                echo "<div class='mycart-item-lower'>";
                                    ...
                                    echo "<div class='mycart-item-lower-2'>";
                                        echo "<div id='paynow-btn' onclick=\"window.location='../user/to_ship_delete.php?cartID=".$row['cart_id']."'\">Cancel Order</div>";
                                    echo "</div>";
                                echo "</div>";
