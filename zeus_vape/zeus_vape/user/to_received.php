...
<body class="body">
    ...
    <section>
        ...
        <div class="mycart-nav-bar">
            ...
            <div style="border-bottom: 4px solid rgb(57, 128, 235);" onclick="window.location='../user/to_received.php'" class="mycart-nav-bar-item">
        ...
        <div class="mycart-container">
            ...
            <br>
                <?php
                    $sqll = "Select count(*) from cart WHERE uid='$uid' AND status='Ongoing Shipment'";
                    ...
                    $sql2 = "Select * from cart WHERE uid='$uid' AND status='Ongoing Shipment' limit $offset, $rec_limit";
                            ...
                            echo "<div style='margin: auto; width: 80%; border: solid black 2px;'>";
                                ...
                                echo "<div class='mycart-item-lower'>";
                                    ...
                                    echo "<div class='mycart-item-lower-2'>";
                                        ...
                                        echo "<div id='paynow-btn' onclick=\"window.location='../user/order_received.php?cartID=".$row['cart_id']."'\">Order Received</div>";
                                    echo "</div>";
                                echo "</div>";
